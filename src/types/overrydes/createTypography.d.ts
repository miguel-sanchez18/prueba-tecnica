...
declare module '@mui/material/styles/createTypography' {
  ...
  export interface TypographyOptions extends Partial<Record<Variant, TypographyStyleOptions> & FontStyleOptions> {
    ...
    tableContent?: TypographyStyleOptions;
    tableContentLink?: TypographyStyleOptions;
    tableContentCommon?: TypographyStyleOptions;
    tableHeader?: TypographyStyleOptions;
    subtitleBold1?: TypographyStyle;
  }
...
declare module '@mui/material/Typography' {
  interface TypographyPropsVariantOverrides {
    tableContent: true;
    tableContentLink: true;
    tableContentCommon: true;
    tableHeader: true;
    subtitleBold1: true;
  }
}
